...
const Sidebar = () => {
  return (
    <section>
      <div className="z-100 hidden md:flex absolute top-[40%] mx-4 w-12 h-44   rounded-md bg-opacity-25 flex-col items-center justify-center gap-2 px-0.5">
        <Link
          href="/"
      ...
      <div className="z-100 w-full items-center flex justify-center">
        {" "}
